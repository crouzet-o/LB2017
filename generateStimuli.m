...
if (keepF>2)
    fprintf(logid, '%s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s ; %s\n', 'output', 'startpoint', 'endpoint', 'numContinuum', 'startF1', 'endF1', 'targetF1', 'zF1', 'stF1', 'startF2', 'endF2', 'targetF2', 'zF2', 'stF2', 'startF3', 'endF3', 'targetF3', 'zF3', 'stF3');
else
